...
public void OnPluginStart()
{
	...
	g_hItemHintCoolDown		= CreateConVar("l4d2_item_hint_cooldown_time", "1.0", "玩家可以再次使用“Look”物品提示的冷却时间（以秒为单位）.", FCVAR_NOTIFY, true, 0.0);
	g_hItemUseHintRange		= CreateConVar("l4d2_item_hint_use_range", "150", "玩家可以在多近的地方使用“Look”物品提示.", FCVAR_NOTIFY, true, 1.0);
	g_hItemUseSound			= CreateConVar("l4d2_item_hint_use_sound", "buttons/blip1.wav", "物品提示音. （相对于声音/，空=关）", FCVAR_NOTIFY);
	g_hItemAnnounceType		= CreateConVar("l4d2_item_hint_announce_type", "1", "更改物资提示的显示方式. （0：禁用，1：在聊天中，2：在提示框中，3：在中心文本中）", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	...
	g_hItemCvarColor		= CreateConVar("l4d2_item_hint_glow_color", "200 200 200", "项目发光颜色,0-255 之间的三个值,以空格分隔. （空 = 禁用项目发光）", FCVAR_NOTIFY);
	g_hItemInstructorHint	= CreateConVar("l4d2_item_instructorhint_enable", "1", "如果为 1,则在标记的物资上创建游戏自带提示.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hItemInstructorColor	= CreateConVar("l4d2_item_instructorhint_color", "0 255 255", "标记的物资上的提示颜色.", FCVAR_NOTIFY);
	g_hItemInstructorIcon	= CreateConVar("l4d2_item_instructorhint_icon", "icon_interact", "标记项目上的提示图标名称。 （更多图标：https://developer.valvesoftware.com/wiki/Env_instructor_hint）", FCVAR_NOTIFY);

	g_hSpotMarkCoolDown			= CreateConVar("l4d2_spot_marker_cooldown_time", "2.5", "玩家可以再次使用“Look”Spot Marker 的冷却时间（以秒为单位）.", FCVAR_NOTIFY, true, 0.0);
	g_hSpotMarkUseRange     	= CreateConVar("l4d2_spot_marker_use_range", "1800", "玩家可以在多远的地方使用“Look” Spot Marker.", FCVAR_NOTIFY, true, 1.0);
	g_hSpotMarkUseSound     	= CreateConVar("l4d2_spot_marker_use_sound", "buttons/blip1.wav", "点标记声音. （相对于声音/，空=关）", FCVAR_NOTIFY);
	g_hSpotMarkAnnounceType		= CreateConVar("l4d2_spot_marker_announce_type", "0", "更改点标记提示的显示方式. （0：禁用，1：在聊天中，2：在提示框中，3：在中心文本中）", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	g_hSpotMarkGlowTimer		= CreateConVar("l4d2_spot_marker_duration", "10.0", "点标记持续时间.", FCVAR_NOTIFY, true, 0.0);
	g_hSpotMarkCvarColor		= CreateConVar("l4d2_spot_marker_color", "200 200 200", "点标记发光颜色,0-255 之间的三个值,以空格分隔. （空 = 禁用点标记）", FCVAR_NOTIFY);
	g_hSpotMarkSpriteModel      = CreateConVar("l4d2_spot_marker_sprite_model", "materials/vgui/icon_arrow_down.vmt", "点标记精灵的模型。 （空=禁用）");
	g_hSpotMarkInstructorHint	= CreateConVar("l4d2_spot_marker_instructorhint_enable", "1", "如果为 1，则在 Spot 标记上创建游戏自带提示提示.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hSpotMarkInstructorColor	= CreateConVar("l4d2_spot_marker_instructorhint_color", "200 200 200", "点标记上的提示颜色.", FCVAR_NOTIFY);
	g_hSpotMarkInstructorIcon	= CreateConVar("l4d2_spot_marker_instructorhint_icon", "icon_info", "点标记上的提示图标名称.", FCVAR_NOTIFY);

	g_hInfectedMarkCoolDown		= CreateConVar("l4d2_infected_marker_cooldown_time", "0.25", "可以再次标记特感的冷却时间（以秒为单位）.", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedMarkUseRange     = CreateConVar("l4d2_infected_marker_use_range", "1800", "可以在多远的地方使用标记来标记特感.", FCVAR_NOTIFY, true, 1.0);
	g_hInfectedMarkUseSound		= CreateConVar("l4d2_infected_marker_use_sound", "items/suitchargeok1.wav", "标记特感声音. （相对于声音/，空=关）", FCVAR_NOTIFY);
	g_hInfectedMarkAnnounceType	= CreateConVar("l4d2_infected_marker_announce_type", "1", "更改标记特感提示的显示方式. （0：禁用，1：在聊天中，2：在提示框中，3：在中心文本中）", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	g_hInfectedMarkGlowTimer   	= CreateConVar("l4d2_infected_marker_glow_timer", "10.0", "标记特感后的发光时间.", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedMarkGlowRange   	= CreateConVar("l4d2_infected_marker_glow_range", "2500", "标记特感后的发光范围", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedMarkCvarColor   	= CreateConVar("l4d2_infected_marker_glow_color", "255 120 203", "标记特感后的发光颜色, 0-255 之间的三个值,以空格分隔. （空 = 禁用特感玩家标记）", FCVAR_NOTIFY);
	g_hInfectedMarkWitch    	= CreateConVar("l4d2_infected_marker_witch_enable", "1", "如果为 1，则允许标志witch.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
...
void CreateStringMap()
{
	...
	*/
	g_smModelToName.SetString("models/infected/boomette.mdl",							"前面有只Boomer!");
	g_smModelToName.SetString("models/infected/boomer.mdl",								"前面有只Boomer!");
	g_smModelToName.SetString("models/infected/boomer_l4d1.mdl",						"前面有只Boomer!");
	g_smModelToName.SetString("models/infected/hulk.mdl",								"前面有只Tank!");
	g_smModelToName.SetString("models/infected/hulk_l4d1.mdl",							"前面有只Tank!");
	g_smModelToName.SetString("models/infected/hulk_dlc3.mdl",							"前面有只Tank!");
	g_smModelToName.SetString("models/infected/smoker.mdl",								"前面有只Smoker!");
	g_smModelToName.SetString("models/infected/smoker_l4d1.mdl",						"前面有只Smoker!");
	g_smModelToName.SetString("models/infected/hunter.mdl",								"前面有只Hunter!");
	g_smModelToName.SetString("models/infected/hunter_l4d1.mdl",						"前面有只Hunter!");
	g_smModelToName.SetString("models/infected/witch.mdl",								"前面有只Witch!");
	g_smModelToName.SetString("models/infected/witch_bride.mdl",						"前面有只Witch!");
	g_smModelToName.SetString("models/infected/spitter.mdl",							"前面有只Spitter!");
	g_smModelToName.SetString("models/infected/jockey.mdl",								"前面有只Jockey!");
	g_smModelToName.SetString("models/infected/charger.mdl",							"前面有只Charger!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_medkit.mdl", 				"这有医疗包!");
	//g_smModelToName.SetString("models/w_models/weapons/w_eq_Medkit.mdl",				"这有医疗包!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_defibrillator.mdl",			"这有电击器!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_painpills.mdl",				"这有止痛药!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_adrenaline.mdl",			"这有肾上腺素!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_bile_flask.mdl",			"这有胆汁!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_molotov.mdl",				"这有燃烧弹!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_pipebomb.mdl",				"这有土质炸弹!");
	g_smModelToName.SetString("models/w_models/Weapons/w_laser_sights.mdl",				"这有激光瞄准器!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_incendiary_ammopack.mdl",	"这有燃烧弹药包!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_explosive_ammopack.mdl",	"这有高爆弹药包!");
	g_smModelToName.SetString("models/props/terror/ammo_stack.mdl",						"这有弹药堆!");
	g_smModelToName.SetString("models/props_unique/spawn_apartment/coffeeammo.mdl",		"这有弹药堆!");
	g_smModelToName.SetString("models/props/de_prodigy/ammo_can_02.mdl", 				"这有弹药堆!");
	g_smModelToName.SetString("models/weapons/melee/w_chainsaw.mdl",				 	"这有电锯!");
	g_smModelToName.SetString("models/w_models/weapons/w_pistol_b.mdl", 				"这有小手枪!");
	g_smModelToName.SetString("models/w_models/weapons/w_pistol_a.mdl", 				"这有小手枪!");
	g_smModelToName.SetString("models/w_models/weapons/w_desert_eagle.mdl", 			"这有马格南!");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun.mdl", 					"这有铁喷!");
	g_smModelToName.SetString("models/w_models/weapons/w_pumpshotgun_A.mdl", 			"这有木喷!");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_uzi.mdl", 					"这有Uzi!");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_a.mdl", 					"这有消音冲锋枪!");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_mp5.mdl", 					"这有MP5!");
	g_smModelToName.SetString("models/w_models/weapons/w_rifle_m16a2.mdl", 				"这有m416!");
	g_smModelToName.SetString("models/w_models/weapons/w_rifle_sg552.mdl", 				"这有SG552!");
	g_smModelToName.SetString("models/w_models/weapons/w_rifle_ak47.mdl", 				"这有AK47!");
	g_smModelToName.SetString("models/w_models/weapons/w_desert_rifle.mdl", 			"这有scar!");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun_spas.mdl", 			"这有二代连喷!");
	g_smModelToName.SetString("models/w_models/weapons/w_autoshot_m4super.mdl", 		"这有一代连喷!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_mini14.mdl", 			"这有15发连狙（猎枪）!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_military.mdl", 			"这有30发连狙（军狙）!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_scout.mdl", 			"这有鸟狙!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_awp.mdl", 				"这有AWP!");
	g_smModelToName.SetString("models/w_models/weapons/w_grenade_launcher.mdl", 		"这有榴弹炮!");
	g_smModelToName.SetString("models/w_models/weapons/w_m60.mdl", 						"这有M60!");
	g_smModelToName.SetString("models/props_junk/gascan001a.mdl", 						"这有油桶!");
	g_smModelToName.SetString("models/props_junk/explosive_box001.mdl", 				"这有烟花盒!");
	g_smModelToName.SetString("models/props_junk/propanecanister001a.mdl", 				"这有煤气罐!");
	g_smModelToName.SetString("models/props_equipment/oxygentank01.mdl", 				"这有氧气罐!");
	g_smModelToName.SetString("models/props_junk/gnome.mdl", 							"这有地精老头!");
	g_smModelToName.SetString("models/w_models/weapons/w_cola.mdl", 					"这有可乐!");
	g_smModelToName.SetString("models/w_models/weapons/50cal.mdl",					 	"这有50口径重机枪!");
	g_smModelToName.SetString("models/w_models/weapons/w_minigun.mdl", 					"这有加特林重机枪!");
	g_smModelToName.SetString("models/w_models/weapons/w_knife_t.mdl", 					"这有小刀!");
	g_smModelToName.SetString("models/weapons/melee/w_bat.mdl", 						"这有棒球棒!");
	g_smModelToName.SetString("models/weapons/melee/w_cricket_bat.mdl", 				"这有板球拍!");
	g_smModelToName.SetString("models/weapons/melee/w_crowbar.mdl", 					"这有撬棍!");
	g_smModelToName.SetString("models/weapons/melee/w_electric_guitar.mdl", 			"这有吉他!");
	g_smModelToName.SetString("models/weapons/melee/w_fireaxe.mdl", 					"这有斧头!");
	g_smModelToName.SetString("models/weapons/melee/w_frying_pan.mdl", 					"这有平底锅!");
	g_smModelToName.SetString("models/weapons/melee/w_katana.mdl", 						"这有武士刀!");
	g_smModelToName.SetString("models/weapons/melee/w_machete.mdl", 					"这有砍刀!");
	g_smModelToName.SetString("models/weapons/melee/w_tonfa.mdl", 						"这有警棍!");
	g_smModelToName.SetString("models/weapons/melee/w_golfclub.mdl", 					"这有高尔夫球棍!");
	g_smModelToName.SetString("models/weapons/melee/w_pitchfork.mdl", 					"这有草叉!");
	g_smModelToName.SetString("models/weapons/melee/w_shovel.mdl", 						"这有铁铲!");
	g_smModelToName.SetString("models/props/terror/exploding_ammo.mdl", 				"这有已经放置的高爆弹!");
	g_smModelToName.SetString("models/props/terror/incendiary_ammo.mdl", 				"这有已经放置的燃烧弹!");
