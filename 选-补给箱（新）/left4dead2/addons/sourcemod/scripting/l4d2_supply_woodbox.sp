...
public void OnPluginStart()
{
	...
	g_hCvarDropItemMax =		CreateConVar(	"l4d2_supply_woodbox_item_max",			"8",			"Max Items that could drop in woodbox.", CVAR_FLAGS, true, 0.0); 
	g_hCvarDropItemMin =		CreateConVar(	"l4d2_supply_woodbox_item_min",			"4",			"Min Items that could drop in woodbox.", CVAR_FLAGS, true, 0.0); 
	...
	g_hSupplyBoxMaxTime =		CreateConVar(	"l4d2_supply_woodbox_time_max",			"180",			"Set the max spawn time for Supply box drop.", CVAR_FLAGS, true, 5.0); 
	g_hSupplyBoxMinTime =		CreateConVar(	"l4d2_supply_woodbox_time_min",			"120",			"Set the min spawn time for Supply box drop.", CVAR_FLAGS, true, 0.0); 
	...
	g_hSupplyBoxSpawnFinal = 	CreateConVar(	"l4d2_supply_woodbox_drop_final",		"1", 			"If 1, still dorp supply box in final stage rescue", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	g_hItemAnnounceType = 		CreateConVar(	"l4d2_supply_woodbox_announce_type", 	"2", 			"Changes how Supply box hint displays. (0: Disable, 1:In chat, 2: In Hint Box, 3: In center text)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
