...
public void OnPluginStart() {
	...
	g_cBreakTheDoor =	CreateConVar("l4d2_dlock_weakdoor",		"0",	"Saferoom door will be breaked, once opened.", CVAR_FLAGS);
	g_cPrepareTime1r =	CreateConVar("l4d2_dlock_prepare1st",	"15",	"How many seconds plugin will wait after all clients have loaded before starting first round on a map", CVAR_FLAGS);
	g_cPrepareTime2r =	CreateConVar("l4d2_dlock_prepare2nd",	"15",	"How many seconds plugin will wait after all clients have loaded before starting second round on a map", CVAR_FLAGS);
	...
	g_cDisplayPanel =	CreateConVar("l4d2_dlock_displaypanel",	"0",	"Display players state panel. 0-disabled, 1-hide failed, 2-full info", CVAR_FLAGS);
